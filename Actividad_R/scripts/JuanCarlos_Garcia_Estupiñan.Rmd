...
```{r}
### Con la función system() (base) podemos correr comandos de bash en un script de R
### comandos que son muy útiles para estos trabajos.

## Creamos una variable para filtrar las frecuencias que empiezan por ACCT
x <- 'grep -v ">" ../data_raw/ncrna_NONCODE[v3.0].fasta | grep "^ACCT" > ../data_raw/empieza_acct.txt'
system(x)
...
x1 <- 'grep -v ">" ../data_raw/ncrna_NONCODE[v3.0].fasta | grep "TTTTTT$" > ../data_raw/empieza_acct.txt'
system(x1)

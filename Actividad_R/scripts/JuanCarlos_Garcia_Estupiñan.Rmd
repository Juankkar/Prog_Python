...
## Además a mi ordenador le cuesta trabajar con listas tan largas
...
## Y creamos un tibble con header como columna 1 y secuencia como columna 2 
df_ncrna <- tibble(
    header=header,
    secuencia=secuencia
  )
...
```{r}
## Mismo procedimiento que el ejercicio anterior a partir de df_ncrna
